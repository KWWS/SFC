...
begin
   ...
   begin
      if Application.MessageBox('Deseja apagar este Cliente?', 'Exclusão', MB_ICONQUESTION +
      ...
      begin
          try
            ...
            Application.MessageBox('Cliente apagado com sucesso!', 'Exclusão', MB_ICONINFORMATION + MB_OK);
          except
